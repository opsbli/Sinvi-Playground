...
from . import runtime_env as runtime_env_helpers
from . import runtime_fallbacks
...
class LLMGateway:
    ...
    def _is_tool_blocked_response(self, text: str) -> bool:
        return runtime_fallbacks.is_tool_blocked_response(text)

    def _format_tool_runtime_issue(self, text: str, agent: AgentDefinition) -> str:
        return runtime_fallbacks.format_tool_runtime_issue(text, agent)
    ...
    def _fallback_route(
        ...
        return runtime_fallbacks.fallback_route(user_input, agents)
    ...
    def _default_runtime_env(self) -> dict[str, str]:
        ...
        return runtime_env_helpers.load_default_runtime_env(
            base_env=os.environ,
    ...
    def _build_runtime_env(
        ...
        *,
        ...
        return runtime_env_helpers.build_runtime_env(
            default_env=self._default_runtime_env(),
    ...
    def _fallback_agent_response(
        ...
        return runtime_fallbacks.fallback_agent_response(agent, user_input, system_prompt)

    def _parse_task_list(self, content: str, max_tasks: int) -> list[str]:
        return runtime_fallbacks.parse_task_list(content, max_tasks)

    def _fallback_plan_tasks(self, user_input: str, max_tasks: int = 4) -> list[str]:
        return runtime_fallbacks.fallback_plan_tasks(user_input, max_tasks=max_tasks)

    def _parse_supervisor_decision(self, content: str) -> tuple[bool, str, str] | None:
        return runtime_fallbacks.parse_supervisor_decision(content)
    ...
    def _fallback_supervisor_review_decision(
        ...
        *,
        ...
        return runtime_fallbacks.fallback_supervisor_review_decision(
            user_input=user_input,
            reports=reports,
            cycle=cycle,
            max_cycles=max_cycles,
